...
console.log(city)
  ...
  <div className="appTitle"><CloudIcon className="appTitleIcon"/>Weather App</div>
     ...
     <div className ="overViewCard-top" style={{backgroundColor:`${getRandomColor()}`}}>
    <div id="backIcon"> <ArrowBackIcon id="backIcon"  onClick={() => goTo()}/></div>
    ...
    <div className="description-OvFlex">
     ...
     <div className="description-Ov">{city.weather[0].description}</div>
     </div>
     ...
     <div className="temp-OV">{Math.round(city.main.temp)}&deg;C</div>
     <div className="temp_min-OV">Temp Min: {Math.round(city.main.temp_min)}&deg;C</div>
     <div className="temp_max-OV">Temp Max: {Math.round(city.main.temp_max)}&deg;C</div>
     </div>
